 ...
 */
class Tetrahedron : public Element3D, public Material {
 public:
  /**
   ...
   */
  Tetrahedron(Vertex v1, Vertex v2, Vertex v3, Vertex v4, Material material) : Element3D({v1, v2, v3, v4}), Material(material) {}
